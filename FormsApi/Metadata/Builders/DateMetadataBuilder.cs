    ...
    IVisible<DateMetadataBuilder<TModel>, TModel>
{
    ...
    public FormValueRefBuilder<TModel, DateOnly>? MinValue { get; set; }
    public FormValueRefBuilder<TModel, DateOnly>? MaxValue { get; set; }
    public FormValueRefBuilder<TModel, bool>? Visible { get; set; }
    public FieldType GetFieldType() => FieldType.Date;
}
